    ...
    <div className="page">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.3fr', gap: 14, marginTop: 14 }}>
        <div className="card" style={{ padding: 16, borderLeft: '3px solid #8B5CF6' }}>
          ...
          <div style={{ fontSize: 18, fontWeight: 800, fontFamily: MONO, color: '#8B5CF6', margin: '4px 0' }}>{s.ghost.predictedLap}</div>
        ...
        <div className="card" style={{ padding: 16, background: 'rgba(139,92,246,0.06)', border: '1px solid rgba(139,92,246,0.3)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 6 }}>
            ...
            <span style={{ fontSize: 9, fontFamily: MONO, color: '#8B5CF6', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Oracle simulation verdict</span>
          </div>
