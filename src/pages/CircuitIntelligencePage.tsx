...
const RIVALS: RivalDef[] = [
  { name: 'Marquez',    num: 93, color: '#FF3B3B', trackOffset: +0.020 },
  { name: 'Martin',     num: 89, color: '#FCD34D', trackOffset: +0.009 },
  { name: 'Bastianini', num: 23, color: '#60A5FA', trackOffset: -0.005 },
];
