    ...
    <div className="page">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 14, marginTop: 14 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div className="card" style={{ padding: 16, borderLeft: '3px solid #FF6A00' }}>
      ...
      <div className="card" style={{ padding: 16, marginTop: 14, background: 'rgba(139,92,246,0.06)', border: '1px solid rgba(139,92,246,0.3)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 6 }}>
          ...
          <span style={{ fontSize: 9, fontFamily: MONO, color: '#8B5CF6', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Oracle human verdict</span>
        </div>
