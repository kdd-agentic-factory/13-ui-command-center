...
// ──── Analysis channels ────
  const CHANNEL_DEFS: (Omit<Channel, 'data'> & { group: string; quality: string })[] = [
    ...
    { id: 'lean',   name: 'LEAN',     unit: '°',    color: 'var(--violet)', range: [0, 63],    panelHeight: 48, group: 'Bike Dynamics', quality: 'OK' },
    ...
    { id: 'ftyre',  name: 'F TYRE',   unit: '°C',   color: 'var(--blue)', range: [40, 140],  panelHeight: 46, group: 'Tyres / Grip',  quality: 'OK' },
    { id: 'rtyre',  name: 'R TYRE',   unit: '°C',   color: 'var(--orange)', range: [40, 140],  panelHeight: 46, group: 'Tyres / Grip',  quality: 'OK' },
