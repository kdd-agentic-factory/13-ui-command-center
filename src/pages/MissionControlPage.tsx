...
// â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬ Pieces â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬â’—¢â¢Ã¢—š¬—”â¢—š—¬
  ...
  return (
    <div className="cockpit-bg" style={{ position: 'fixed', inset: 0, overflowY: 'auto', zIndex: 50 }}>
      ...
      <div style={{ position: 'relative', maxWidth: 1180, margin: '0 auto', padding: '38px 24px 60px' }}>
        ...
        {/* â’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Â 1 â’—šâ—š—· Hero + system status â’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Â */}
...
{t('mc.tagline', 'Your intelligent digital pit-box for analysing circuits, stints, telemetry, setup, tyres, risk and rider performance. Before analysing a lap, KDD understands the circuit, the working mode and the available data.')}
        ...
        {/* â’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Â 3 â’—šâ—š—· Primary action cards â’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Â */}
        ...
        {/* â’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Â 4 â’—šâ—š—· Lower bento â’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Ââ’—¢â¢Ã¢—š¬—¢â—š—Â */}
