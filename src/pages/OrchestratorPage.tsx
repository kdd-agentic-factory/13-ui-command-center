...
export function OrchestratorPage() {
  ...
  return (
    <div className="page">
        ...
        <div style={{ display: 'flex', gap: 4 }}>
          {ORCH_MODES.map(m => (
            <button key={m} onClick={() => setMode(m)}
              style={{ fontSize: 9.5, fontFamily: MONO, padding: '4px 8px', borderRadius: 6, cursor: 'pointer', textTransform: 'capitalize',
      ...
      <div className="card mb-4" style={{ padding: 16, borderLeft: `4px solid ${mm.color}` }}>
        ...
        <div style={{ marginTop: 6, fontSize: 11.5 }}>
          ...
          <span style={{ color: 'var(--text-muted)' }}> · Oracle: </span><span style={{ color: '#8B5CF6' }}>{o.context.oracleVerdict}</span>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginTop: 14 }}>
        ...
        <div className="card" style={{ padding: 16, borderLeft: `3px solid ${missionStatusMeta(o.debrief.status).color}` }}>
