        ...
        <div className="card-body">
          <div className="grid-3">
            {CRITICAL_CORNERS.map(corner => (
              <div key={corner.corner} style={{ padding: 13, border: '1px solid var(--border)', borderRadius: 10, background: 'rgba(255,255,255,0.03)' }}>
        ...
        <div className="card-body">
          <div className="grid-4">
            {VALIDATION_TARGETS.map(group => (
              <div key={group.area} style={{ padding: 12, border: '1px solid var(--border)', borderRadius: 10, background: 'rgba(255,255,255,0.03)' }}>
