...
export type TabId = 'cockpit' | 'overview' | 'live' | 'telemetry' | 'circuit' | 'corners' | 'replay' | 'compare' | 'ghost-lap' | 'studio' | 'track-evo' | 'surface' | 'risk' | 'predict' | 'tires' | 'setup' | 'advisor' | 'setup-lab' | 'parts' | 'bike-compare' | 'twin' | 'sandbox' | 'experiments' | 'events' | 'history' | 'pre-gp' | 'crew' | 'copilot' | 'learning-path' | 'pit-radio' | 'team' | 'workbench' | 'orchestrator' | 'report' | 'debrief' | 'black-box' | 'knowledge' | 'patterns' | 'ai-crew' | 'style' | 'cube' | 'trust' | 'platform' | 'data' | 'settings';
...
export const PROFILES: Profile[] = [
  ...
  },
  {
    ...
    icon: '👔',
    accessCount: '14',
    allowedTabs: ['cockpit','overview','live','corners','compare','ghost-lap','track-evo','surface','risk','predict','report','debrief','black-box','experiments','history','pre-gp','copilot','learning-path','pit-radio','team','orchestrator','ai-crew','circuit','tires','cube','trust','settings'],
    defaultTab: 'overview',
    requiresAuth: true,
  },
  {
    ...
    icon: '📊',
    accessCount: '14',
    allowedTabs: ['cockpit','telemetry','corners','replay','compare','ghost-lap','studio','track-evo','surface','predict','tires','circuit','twin','sandbox','experiments','events','history','report','debrief','black-box','knowledge','patterns','learning-path','team','workbench','ai-crew','style','bike-compare','setup-lab','cube','trust','platform','data','settings'],
