...
export type TabId = 'overview' | 'live' | 'telemetry' | 'circuit' | 'corners' | 'replay' | 'compare' | 'risk' | 'predict' | 'tires' | 'setup' | 'advisor' | 'setup-lab' | 'parts' | 'bike-compare' | 'twin' | 'history' | 'pre-gp' | 'crew' | 'copilot' | 'report' | 'debrief' | 'ai-crew' | 'style' | 'data' | 'settings';
...
export const PROFILES: Profile[] = [
  {
    ...
    icon: '⚙️',
    accessCount: '23',
    allowedTabs: ['overview','live','telemetry','circuit','corners','replay','compare','risk','predict','tires','setup','advisor','setup-lab','parts','bike-compare','twin','history','pre-gp','crew','copilot','report','ai-crew','style','data','settings'],
    defaultTab: 'overview',
    requiresAuth: true,
  },
  {
    ...
    icon: '👔',
    accessCount: '14',
    allowedTabs: ['overview','live','corners','compare','risk','predict','report','debrief','history','pre-gp','copilot','ai-crew','circuit','tires','settings'],
    defaultTab: 'overview',
    requiresAuth: true,
  },
  {
    ...
    icon: '📊',
    accessCount: '14',
    allowedTabs: ['telemetry','corners','replay','compare','predict','tires','circuit','twin','history','report','debrief','ai-crew','style','bike-compare','setup-lab','data','settings'],
