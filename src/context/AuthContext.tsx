...
export const PROFILES: Profile[] = [
  ...
  },
  {
    ...
    icon: '📊',
    accessCount: '14',
    allowedTabs: ['cockpit','telemetry','corners','replay','compare','ghost-lap','studio','track-evo','surface','predict','tires','circuit','twin','sandbox','experiments','events','history','report','debrief','black-box','knowledge','patterns','learning-path','human','team','workbench','ai-crew','style','bike-compare','setup-lab','cube','trust','platform','federated','data','settings'],
