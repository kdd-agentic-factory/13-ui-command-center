...
export type TabId = 'cockpit' | 'overview' | 'live' | 'telemetry' | 'circuit' | 'corners' | 'replay' | 'compare' | 'ghost-lap' | 'studio' | 'track-evo' | 'risk' | 'predict' | 'tires' | 'setup' | 'advisor' | 'setup-lab' | 'parts' | 'bike-compare' | 'twin' | 'sandbox' | 'experiments' | 'events' | 'history' | 'pre-gp' | 'crew' | 'copilot' | 'learning-path' | 'pit-radio' | 'team' | 'report' | 'debrief' | 'black-box' | 'knowledge' | 'patterns' | 'ai-crew' | 'style' | 'cube' | 'trust' | 'platform' | 'data' | 'settings';
...
export const PROFILES: Profile[] = [
  {
    ...
    icon: '⚙️',
    accessCount: '23',
    allowedTabs: ['cockpit','overview','live','telemetry','circuit','corners','replay','compare','ghost-lap','studio','track-evo','risk','predict','tires','setup','advisor','setup-lab','parts','bike-compare','twin','sandbox','experiments','events','history','pre-gp','crew','copilot','learning-path','pit-radio','team','report','ai-crew','style','cube','trust','platform','patterns','data','settings'],
    defaultTab: 'overview',
    requiresAuth: true,
  },
  {
  ...
  },
  {
    ...
    icon: '📊',
    accessCount: '14',
    allowedTabs: ['cockpit','telemetry','corners','replay','compare','ghost-lap','studio','track-evo','predict','tires','circuit','twin','sandbox','experiments','events','history','report','debrief','black-box','knowledge','patterns','learning-path','team','ai-crew','style','bike-compare','setup-lab','cube','trust','platform','data','settings'],
