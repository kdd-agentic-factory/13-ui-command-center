...
export const PROFILES: Profile[] = [
  ...
  },
  {
    ...
    icon: '👔',
    accessCount: '14',
    allowedTabs: ['cockpit','overview','live','corners','compare','ghost-lap','track-evo','surface','risk','predict','strategy','rivals','quali','report','debrief','black-box','experiments','history','pre-gp','copilot','learning-path','human','pit-radio','team','orchestrator','season','ai-crew','circuit','tires','cube','trust','settings'],
    defaultTab: 'overview',
    requiresAuth: true,
  },
  {
    ...
    icon: '📊',
    accessCount: '14',
    allowedTabs: ['cockpit','telemetry','corners','replay','compare','ghost-lap','studio','track-evo','surface','predict','strategy','rivals','quali','tires','circuit','twin','sandbox','sim-lab','experiments','events','causal','history','report','debrief','black-box','knowledge','patterns','learning-path','human','team','workbench','season','ai-crew','style','bike-compare','setup-lab','brakes','electronics','cube','trust','platform','federated','edge','lakehouse','devhub','data','settings'],
  ...
  },
  {
    ...
    icon: '🔧',
    accessCount: '7',
    allowedTabs: ['setup','advisor','electronics','setup-lab','parts','brakes','bike-compare','pre-gp','tires','track-evo','team','trust','data','settings'],
    defaultTab: 'setup',
    requiresAuth: true,
  },
  {
