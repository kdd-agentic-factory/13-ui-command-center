...
export type TabId = 'cockpit' | 'overview' | 'live' | 'telemetry' | 'circuit' | 'corners' | 'replay' | 'compare' | 'ghost-lap' | 'studio' | 'track-evo' | 'surface' | 'weather' | 'risk' | 'predict' | 'strategy' | 'rivals' | 'quali' | 'tires' | 'pressure' | 'setup' | 'advisor' | 'electronics' | 'aero' | 'fuel' | 'chassis' | 'setup-lab' | 'parts' | 'brakes' | 'bike-compare' | 'twin' | 'sandbox' | 'sim-lab' | 'experiments' | 'events' | 'causal' | 'history' | 'pre-gp' | 'crew' | 'copilot' | 'learning-path' | 'human' | 'pit-radio' | 'team' | 'workbench' | 'orchestrator' | 'season' | 'report' | 'debrief' | 'black-box' | 'knowledge' | 'patterns' | 'federated' | 'ai-crew' | 'style' | 'cube' | 'trust' | 'platform' | 'edge' | 'lakehouse' | 'devhub' | 'data' | 'settings';
...
export const PROFILES: Profile[] = [
  ...
  },
  {
    ...
    icon: '👔',
    accessCount: '14',
    allowedTabs: ['cockpit','overview','live','corners','compare','ghost-lap','track-evo','surface','weather','risk','predict','strategy','rivals','quali','report','debrief','black-box','experiments','history','pre-gp','copilot','learning-path','human','pit-radio','team','orchestrator','season','ai-crew','circuit','tires','cube','trust','settings'],
    defaultTab: 'overview',
    requiresAuth: true,
  },
  {
    ...
    icon: '📊',
    accessCount: '14',
    allowedTabs: ['cockpit','telemetry','corners','replay','compare','ghost-lap','studio','track-evo','surface','weather','predict','strategy','rivals','quali','tires','pressure','circuit','twin','sandbox','sim-lab','experiments','events','causal','history','report','debrief','black-box','knowledge','patterns','learning-path','human','team','workbench','season','ai-crew','style','bike-compare','setup-lab','brakes','electronics','aero','fuel','chassis','cube','trust','platform','federated','edge','lakehouse','devhub','data','settings'],
  ...
  },
  {
    ...
    icon: '🔧',
    accessCount: '7',
    allowedTabs: ['setup','advisor','electronics','aero','fuel','chassis','setup-lab','parts','brakes','bike-compare','pre-gp','tires','pressure','track-evo','weather','team','trust','data','settings'],
    defaultTab: 'setup',
    requiresAuth: true,
  },
  {
