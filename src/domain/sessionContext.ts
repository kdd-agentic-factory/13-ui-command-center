...
export const MODULE_LABELS: Partial<Record<TabId, string>> = {
  ...
  trust: 'Data Trust Center', cube: 'Telemetry Data Cube', platform: 'Platform Console', patterns: 'Pattern Miner', events: 'Event Engine', workbench: 'Visualization OS', orchestrator: 'Autonomous Race Engineer', human: 'Human Performance',
};
